...
\usecolortheme{spruce} % seahorse, spruce, beaver, 
...
\begin{frame}
    \frametitle{Wielkość forów}

\end{frame}

\begin{frame}
    \frametitle{Aktywność w czasie}

\end{frame}

\begin{frame}
    \frametitle{Wpływ wydarzeń na aktywność}

\end{frame}

\begin{frame}
    \frametitle{Rozłożenie użytkowników na świecie}
