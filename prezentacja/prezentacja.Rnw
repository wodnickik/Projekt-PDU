...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item<3-> Aktywność w czasie
        \item<4-> Wpływ wydarzeń na aktywność
        \item<5-> Rozłożenie użytkowników na świecie
        \item<6-> Czas odpowiedzi na pytania
    \end{itemize}
    \end{block}
...
\subsection{Aktywność w czasie}

\begin{frame}
    \frametitle{Pytania}
    \begin{figure}
        \centering\includegraphics[width=\textwidth]{wykresy/wyk_akt_que.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        \centering\includegraphics[width=\textwidth]{wykresy/wyk_akt_ans.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    \frametitle{Komentarze}
    \begin{figure}
        \centering\includegraphics[width=\textwidth]{wykresy/wyk_akt_com.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    \frametitle{Linki}
    \begin{figure}
        \centering\includegraphics[width=\textwidth]{wykresy/wyk_akt_lin.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    \frametitle{Głosy}
    \begin{figure}
        \centering\includegraphics[width=\textwidth]{wykresy/wyk_akt_vot.png}
    \end{figure}
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
            \begin{subfigure}[c]{0.3\textwidth}
                \centering\includegraphics[width=\textwidth]{wykresy/median_times.png}
            \end{subfigure}
            \begin{subfigure}[c]{0.3\textwidth}
                \centering\includegraphics[width=\textwidth]{wykresy/mean_times.png}
            \end{subfigure}
            \begin{subfigure}[c]{0.3\textwidth}
                \centering\includegraphics[width=\textwidth]{wykresy/max_times.png}
            \end{subfigure}
    \end{figure}
\end{frame}
